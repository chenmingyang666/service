            ...
            this.config = {
                verify: {
                    ...
                    account: function (value, item) { //value：表单的值、item：表单的DOM对象
                        ...
                        ,
                    password: [
                        /^[\S]{8,30}$/, '密码必须8到30位，且不能出现空格'
                    ],repass:function(t){if(t!==i("#LAY_password").val())return"两次密码输入不一致"}
                }
            }
        };
        ...
        var n = this,
            ...
            d = {
                select: function () {
                    var e,
                        ...
                        v = function (t, l) {
                            i(t.target)
                                .parent()
                                .hasClass(n) && !l || (i("." + a).removeClass(a + "ed " + a + "up"), e && d && e.val(d)),
                            e = null
                        },
                        y = function (t, u, f) {
                            var y,
                            ...
                            if (!u) {
                                var C = function () {
                                        var e = t
                                                .offset()
                                                .top + t.outerHeight() + 5 - h.scrollTop(),
                                            i = x.outerHeight();
                                        b = p[0].selectedIndex,
                                        t.addClass(a + "ed"),
                                        g.removeClass(o),
                                ...
                                k.on("keyup", function (e) {
                                    ...
                                    .on("keydown", function (e) {
                                        ...
                                        var t = function (i, a) {
                                            ...
                                            n = r[i]("dd:not(." + o + ")"),
                                            l[0]
                                                ? (y = r[i](), n[0] && !n.hasClass(c) || !y[0]
                                                    ? (n.addClass(s).siblings().removeClass(s), void $())
                                                    : t(i, y))
                                                : y = null
                                        };
                                        38 === i && t("prev"),
                                ...
                                var T = function (e, t, a) {
                                    ...
                                    j = function (e) {
                                        ...
                                        return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && (T(i, function (e) {
                                            e
                                                ? x.find("." + r)[0] || x.append('<p class="' + r + '">无匹配项</p>')
                                                : x
                                                    .find("." + r)
                                                    .remove()
                                ...
                                g.on("click", function () {
                                    ...
                                    return !e.hasClass(c) && (e.hasClass("layui-select-tips")
                                        ? k.val("")
                                        : (k.val(e.text()), e.addClass(s)), e.siblings().removeClass(s), p.val(a).removeClass("layui-form-danger"), layui.event.call(this, l, "select(" + n + ")", {
                                        elem: p[0],
                                        value: a,
                                        othis: t
                                    }), w(!0), !1)
                        ...
                        var h = "string" == typeof r.attr("lay-search"),
                            ...
                            m = i([
                                ...
                                (u
                                    ...
                                    : "") + '">',
                                '<div class="' + n + '">',
                                '<input type="text" placeholder="' + p + '" ' + ('value="' + (d
                                    ? f.html()
                                    : "") + '"') + (h
                                    ? ""
                                ...
                                '<dl class="layui-anim layui-anim-upbit' + (r.find("optgroup")[0]
                                    ? " layui-select-group"
                                    : "") + '">',
                                function (e) {
                                    var i = [];
                                    return layui.each(e, function (e, a) {
                                        0 !== e || a.value
                                            ? "optgroup" === a
                                                ...
                                                : i.push('<dd lay-value="' + a.value + '" class="' + (d === a.value
                                                    ? s
                                                    : "") + (a.disabled
                                                    ? " " + c
                                                    : "") + '">' + a.innerHTML + "</dd>")
                ...
                checkbox: function () {
                    var e = {
                            checkbox: [
                                "layui-form-checkbox", "layui-form-checked", "checkbox"
                            ],
                        ...
                        a = function (e, t) {
                            ...
                            e.on("click", function () {
                                ...
                                a[0].disabled || (a[0].checked
                                    ...
                                    : (a[0].checked = !0, e.addClass(t[1]).find("em").text(n[0])), layui.event.call(a[0], l, t[2] + "(" + i + ")", {
                                    elem: a[0],
                                    value: a[0].value,
                                    othis: e
                                }))
                    ...
                    a.each(function (a, l) {
                        ...
                        var u = i([
                            ...
                            l.checked
                                ...
                                : "",
                            (o
                                ? " layui-radio-disbaled " + c
                                : "") + '">',
                            '<i class="layui-anim layui-icon">' + t[l.checked
                                    ? 0
                                    : 1] + "</i>",
                            "<div>" + function () {
                                var e = l.title || "";
                                return "string" == typeof r
                                    .next()
                                    .attr("lay-radio") && (e = r.next().html(), r.next().remove()),
                                e
                            }() + "</div>",
                            "</div>"
                        ].join(""));
                ...
                if (r.removeClass(o), layui.each(c, function (e, i) {
                    ...
                    if (a[i]) {
                        ...
                        if (f = f || a[i][1], c) 
                            return "tips" === u
                                ? t.tips(f, function () {
                                    return "string" == typeof r.attr("lay-ignore") || "select" !== l
                                        .tagName
                                        .toLowerCase() && !/^checkbox|radio$/.test(l.type)
                                        ? r
                                        : r.next()
                                }(), {tips: 1})
                                : "alert" === u
