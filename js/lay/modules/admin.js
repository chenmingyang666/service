...
layui.define("view", function (e) {
        ...
        F = {
            ...
            sideFlexible: function (e) {
                var i = u,
                    ...
                    n = F.screen();
                "spread" === e
                    ? (t.removeClass(x).addClass(g), n < 2
                        ? i.addClass(v)
                        : i.removeClass(v), i.removeClass(C))
                    : (t.removeClass(g).addClass(x), n < 2
                        ? i.removeClass(C)
                        : i.addClass(C), i.removeClass(v)),
                layui
                    .event
                    .call(this, l.MOD_NAME, "side({*})", {status: e})
            },
            escape: function (e) {
                return String(e || "")
                    .replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&amp;")
            ...
            theme: function (e) {
                var t = (l.theme, layui.data(l.tableName)),
                    ...
                    r = i([
                        ".layui-side-menu,", ".layadmin-pagetabs .layui-tab-title li:after,", ".layadmin-pagetabs .layui-tab-title li.layui-this:after,", ".layui-layer-admin .layui-layer-title,", ".layadmin-side-shrink .layui-side-menu .layui-nav>.layui-nav-item>.layui-nav-chi" +
                                "ld",
                        ...
                        ".layui-layout-admin .layui-logo{background-color:{{d.color.logo || d.color.main}" +
                                "} !important;}",
                        "{{# if(d.color.header){ }}",
                        ...
                        ".layui-layout-admin .layui-header .layui-nav .layui-nav-more{border-top-color: #" +
                                "fbfbfb;}",
                        ".layui-layout-admin .layui-header .layui-nav .layui-nav-mored{border-color: tran" +
                                "sparent; border-bottom-color: #fbfbfb;}",
                        ".layui-layout-admin .layui-header .layui-nav .layui-this:after, .layui-layout-ad" +
                                "min .layui-header .layui-nav-bar{background-color: #fff; background-color: rgba(" +
                                "255,255,255,.5);}",
    ...
    !function () {
        ...
        e.theme
            ? F.theme(e.theme)
            : l.theme && F.initTheme(l.theme.initColorIndex),
